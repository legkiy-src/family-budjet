            ...
            @forelse($accounts as $account)
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-light del-account-btn" role="button" data-bs-toggle="modal" data-bs-target="#warningDelAccount" data-account-id="{{ $account['id'] }}">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="" class="btn btn-primary" role="button" id="delAccountLink">Удалить</a>
                </div>
            </div>
        </div>
    </div>
...
@push('scripts')
    <script>
        $('.del-account-btn').click(function(){
            ...
            $("#delAccountLink").attr('href', 'accounts/' + accountId + '/destroy' );
        });
    </script>
@endpush
