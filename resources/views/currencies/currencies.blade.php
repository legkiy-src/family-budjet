            ...
            @forelse($currencies as $currency)
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-light del-currency-btn" role="button" data-bs-toggle="modal" data-bs-target="#warningDelCurrency" data-currency-id="{{ $currency['id'] }}">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="" class="btn btn-primary" role="button" id="delCurrencyLink">Удалить</a>
                </div>
            </div>
        </div>
    </div>
...
@push('scripts')
    <script>
        $('.del-currency-btn').click(function(){
            let currencyId = $(this).attr('data-currency-id');
            $("#delCurrencyLink").attr('href', 'currencies/' + currencyId + '/destroy' );
        });
    </script>
@endpush
